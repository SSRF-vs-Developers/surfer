...
import de.tubs.cs.ias.surfer.reversing.blobTypes.Equals
...
object IsEqual extends BytecodeReversingRule with LogSupport {

  override val BYTECODE_NAME: String = "IS_EQUAL"
